...
from . import VkEventNames
from handlers import BasePayload


@payload_schema.register(event_name=VkEventNames.PRIVATE_MESSAGE)
...
@local_handler.register(event_name=VkEventNames.PRIVATE_MESSAGE)
